...
$.when(
        ...
        function(errorResponse) {
            ...
            $("#gh-user-data").html(`<h4><img class="patients" src="assets/images/patients_please.gif" alt="loading..." />Too many requests, please wait until ${resetTime.toLocaleTimeString()}</h4>`)
            } else {
